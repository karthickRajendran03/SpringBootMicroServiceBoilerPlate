## Seed code - Boilerplate Code- KeepNote Assignment

### Problem Statement

In this case study - CategoryService, We will write main class for spring boot Application, model class, repository class, service class and interface, logging aspect.
...
### Steps to be followed:
    ...
    step 10: Write code for logger in LoggingAspect.java class consider all methods in controller classes.
    step 11: Go thru CategoryServiceApplication.java class.
    step 12: Run CategoryControllerTest.java class.
